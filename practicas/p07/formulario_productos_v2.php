...
<body>
<form id="formulario" action="http://localhost/practicas_valeriagn/practicas/p07/set_producto_v2.php" method="post" enctype="multipart/form-data">

<h2>Registra nuevos productos</h2>
